    ...
    <div class="jumbotron p-5 mb-4 bg-light">
        <div class="container py-5">
            ...
            <h1 class="display-5 fw-bold">
                Welcome to my personal Boolfolio
            </h1>

            <p class="col-md-8 fs-4">This is my site, where you find all my Boolean's projects.</p>
                        ...
                        <a class="text-decoration-none" href="{{ route('projects.show', $project) }}">
                            <div class="card h-100">
                                @if (Str::startsWith($project->cover_image, 'https://'))
                                    <img height="300" class="rounded-top" src="{{ $project->cover_image }}"
                                        alt="Cover Image">
                                @else
