...
@section('content')
    <div class="bg-dark py-4">
        <div class="container d-flex justify-content-between align-items-center text-light">
            ...
            <a class="btn btn-primary" href="{{ route('projects.index') }}"><i class="fas fa-arrow-left me-1"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 my-5 text-center ">
                ...
                <p><strong>Type:</strong> {{ $project->type ? $project->type->name : 'No Type to this project' }}</p>
                <div class="technologies">
                    <strong>Technologies:</strong>
                    @forelse ($project->technologies as $technology)
                        <span class="badge bg-primary">{{ $technology->name }}</span>
                    @empty
                        <span>Non ci sono tecnologie associate a questo progetto!</span>
                    @endforelse
                </div>
            </div>
        </div>
